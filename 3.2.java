/*
Develop a Java program that takes a string input from the user and applies a custom encryption algorithm (e.g., Caesar cipher, reverse string) to the string. The program should also decrypt the string back to its original form. Implement exception handling to manage invalid inputs and edge cases (e.g., empty strings, null inputs).

Sample Input:
HelloWorld123!

Sample Output:
Encrypted String: !432GqnnrZkho
