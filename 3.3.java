/*Create a Java application that processes multiple large text files concurrently. Each thread should be responsible for reading a file, counting the number of words, and writing the result to an output file. Implement proper synchronization to handle shared resources and ensure thread safety.
...
file2.txt
file3.txt
(Assume that the content of the files is as follows):  

file1.txt: "Hello world"  
file2.txt: "Java programming is fun"  
file3.txt: "Multithreading in Java"
